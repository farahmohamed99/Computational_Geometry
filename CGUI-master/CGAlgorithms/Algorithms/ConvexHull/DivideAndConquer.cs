    ...
    public class DivideAndConquer : Algorithm
    {
        ...
        public List<Point> merge(List<Point> aa, List<Point> bb)
        {
            ...
            do
            {
                ...
                while (CGUtilities.HelperMethods.CheckTurn(new Line(a[uppera].X, a[uppera].Y, b[upperb].X, b[upperb].Y),
                ...
                if (found == true &&
                    (CGUtilities.HelperMethods.CheckTurn(new Line(a[uppera].X, a[uppera].Y, b[upperb].X, b[upperb].Y),
            ...
            {
                found = true;
                while (CGUtilities.HelperMethods.CheckTurn(new Line(b[lowerb].X, b[lowerb].Y, a[lowera].X, a[lowera].Y),
                ...
                while (CGUtilities.HelperMethods.CheckTurn(new Line(a[lowera].X, a[lowera].Y, b[lowerb].X, b[lowerb].Y),
                ...
                if (found == true &&
                    (CGUtilities.HelperMethods.CheckTurn(new Line(a[lowera].X, a[lowera].Y, b[lowerb].X, b[lowerb].Y),
